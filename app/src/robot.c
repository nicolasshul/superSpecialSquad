...
{  
    g_robot_state.input.vy = ((float) g_remote.controller.right_stick.x);
    g_robot_state.input.vx = ((float) g_remote.controller.right_stick.y);
    g_robot_state.input.rotation = ((float) g_remote.controller.left_stick.x); 
}
